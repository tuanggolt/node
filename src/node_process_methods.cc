...
class FastHrtime : public BaseObject {
 ...
 private:
  ...
  static FastHrtime* FromV8Value(Value* value) {
    Object* v8_object = reinterpret_cast<Object*>(value);
  ...
  static void FastNumber(Value* receiver) {
  ...
  static void FastBigInt(Value* receiver) {
